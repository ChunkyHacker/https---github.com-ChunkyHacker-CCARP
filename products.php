...
<body>
  ...
  <h2 style="text-align:center">Materials, Equipments, and Tools</h2>
    ...
    include('config.php');
      ...
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="assets/items/' . $itemimage . '" alt="' . $itemname . '">';
            echo '<h3 class="product-title">' . $itemname . '</h3>';
            echo '<p class="product-price">$' . $price . '</p>';
            echo '<h3 class="product-type">' . $type . '</h3>';
  ...
  <div class="purchase">
      <button><a href="purchase.html">Make a purchase</a> </button>
  </div>
